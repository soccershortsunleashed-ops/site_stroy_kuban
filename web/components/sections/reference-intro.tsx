        ...
        <div className="space-y-5 px-6 text-center">
          <PageReveal>
            <div data-testid="hero-logo-hover" className="logo-float mx-auto w-fit">
              <div className="relative w-fit rounded-md border border-[#cfd6df] bg-white p-3 transition-transform duration-300 ease-out hover:-translate-y-1 hover:scale-110">
                <GlowingEffect
                  spread={38}
                  glow
                  disabled={false}
